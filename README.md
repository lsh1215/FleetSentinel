...
**대역폭은 99배 차이인데 메시지 건수는 오히려 신호가 9배 많습니다.** 하나의 파이프라인으로
...
| 초당 1,466개 잘린 메시지 | **100ms 창 배치** — 500대에서 5,000 msg/s |
| 센서 주기가 955Hz~2Hz | **타임스탬프 3종** + 키프레임(2Hz) 동기화 앵커 |
...
- **MCAP 스윕 누락 (현존 결함)** — 현재 변환기는 키프레임만 담아 원시 데이터의 86%가 빠져 있습니다. P2 수정 대상입니다.
